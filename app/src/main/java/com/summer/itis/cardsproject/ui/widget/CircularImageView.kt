...
//ФОТКА В КРУЖОЧКЕ
class CircularImageView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : android.support.v7.widget.AppCompatImageView(context, attrs, defStyleAttr) {
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        if (attributes.getBoolean(R.styleable.CircularImageView_shadow, false)) {
            shadowRadius = DEFAULT_SHADOW_RADIUS * getContext().resources.displayMetrics.density
    ...
    private fun loadBitmap() {
        if (this.drawableOne === getDrawable())
            return

        this.drawableOne = getDrawable()
        this.image = drawableToBitmap(this.drawableOne)
        updateShader()
    }
    ...
    private fun drawableToBitmap(drawable: Drawable?): Bitmap? {
        ...
        try {
            // Create Bitmap object out of the drawableOne
    ...
    companion object {
        ...
        private val DEFAULT_SHADOW_RADIUS = 4f
    }
    //endregion
